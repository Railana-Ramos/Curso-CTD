CREATE DATABASE MMO_dh;
USE mmo_dh;

create table planos_vips (
...
foreign key (usuario_plano_id)
	references planos_vips (plano_id)
);
...
foreign key (plano_id)
 ...
 INSERT INTO planos_vips (plano_nome,plano_descricao,plano_duracao,plano_valor)
...
select * from planos_vips;
 ...
 values ('Philipe','Souza','1998-05-06','philipesouza@gmail.com','zCristopher','philipe.123','(81)982056321','BR', '1'),
 ('Vinicius','Rodrigues','2000-06-08','vinicinhosgameplay@gmail.com','viiny','@vini@125','(11)915051389','BR', '5'),
 ('Douglas','Lima','2000-08-19','doguinhoMalvado@gmail.com','DogzQ','!!!!!1542!!!!','(31)985245263','BR', '1'),
 ('Lene','Venenoso','2011-01-01','LeninhoDos@gmail.com','Lene589','amominhafamilia123','351 920956755','PT', '3'),
 ('Andre','Vênancios','1978-05-03','Andre_Vênancios123@gmail.com','LordAndrezin','Andre@###12','(31)963353221','BR', '4');
